...
import StyleComponent, { IStyle } from './components/StyleComponent';
export { AnimationComponent, IAnimation, ImageComponent, IImage, LabelComponent, ILabel, StyleComponent, IStyle };
// </autogen>
